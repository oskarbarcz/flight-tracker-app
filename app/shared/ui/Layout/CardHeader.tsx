...
export function CardHeader({ title, actions }: Props) {
  ...
  return (
    <header
      className={twMerge(
        "flex min-h-8 shrink-0 flex-wrap items-center justify-between gap-x-3 gap-y-1 border-b border-gray-200 bg-gray-50 pb-1 pt-[5px] dark:border-gray-700 dark:bg-gray-800",
        INSET[padding],
      )}
    >
