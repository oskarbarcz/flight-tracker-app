import { type Diversion, DiversionReason, DiversionSeverity } from "~/features/diversion/model";
import type { ReportDiversionRequest } from "~/features/diversion/request";
