...
export function MapTopBar({
  ...
  return (
    <div className="@container absolute inset-x-0 top-0 z-20 flex items-center gap-3 border-b border-gray-200 bg-white px-3 py-2 dark:border-gray-700 dark:bg-gray-900">
