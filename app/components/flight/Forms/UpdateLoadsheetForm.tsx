...
export function UpdateLoadsheetForm() {
  return (
    <div className="space-y-6">
      ...
      <h3 className="text-xl font-bold text-gray-700 dark:text-gray-300">Weights</h3>
      <div className="grid grid-cols-2 gap-4">
        <ManagedFloatingInputBlock
          ...
          autoComplete="off"
        />
        <ManagedFloatingInputBlock field="cargo" label="Cargo [tons]" type="number" autoComplete="off" />
        <ManagedFloatingInputBlock field="payload" label="Payload [tons]" type="number" autoComplete="off" />
        <ManagedFloatingInputBlock field="blockFuel" label="Block fuel [tons]" type="number" autoComplete="off" />
      </div>
    </div>
  );
}
