...
export default function SidebarExpander({
  ...
  return (
    <button
      ...
      className="w-min cursor-pointer items-center text-indigo-500 rounded-xl p-2 transition-colors duration-100 hover:bg-gray-100 dark:hover:bg-gray-700 md:flex"
    >
      <HiChevronDoubleLeft
        size="24px"
