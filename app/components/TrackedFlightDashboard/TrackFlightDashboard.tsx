...
export const TrackFlightDashboard = ({flightNumber}: TrackFlightDashboardProps) => {
  ...
  const title = trackedFlight === null ? 'Flight' : `Tracking ${trackedFlight.flightNumber}`;
  ...
  return (
    <div className="container mx-auto py-4 text-gray-800 dark:text-white">
      <div>
        <TrackedFlightStatus callsign={trackedFlight.callsign} flightNumber={trackedFlight.flightNumber}/>
      </div>
      <div className="grid grid-cols-2 gap-4">
        <div>
          <FlightAirports departure={trackedFlight.departure} arrival={trackedFlight.arrival}/>
          <TrackedFlightTimesheet scheduled={trackedFlight.timesheet.scheduled}/>
        </div>
        <div>
          <TrackedFlightDetails callsign={trackedFlight.callsign} flightNumber={trackedFlight.flightNumber}/>
          <TrackedFlightAircraftDetails aircraft={trackedFlight.aircraft} operator={trackedFlight.operator}/>
        </div>
      </div>
    </div>
  );
