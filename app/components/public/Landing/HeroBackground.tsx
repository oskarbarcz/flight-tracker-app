...
export function HeroBackground() {
  return (
    <>
      ...
      <div className="absolute inset-y-0 left-0 w-48 bg-linear-to-t from-white dark:from-gray-950 via-white/60 dark:via-gray-950/60 to-transparent z-0 pointer-events-none transition-colors duration-500" />
      <div className="absolute inset-y-0 right-0 w-48 bg-linear-to-t from-white dark:from-gray-950 via-white/60 dark:via-gray-950/60 to-transparent z-0 pointer-events-none transition-colors duration-500" />
    </>
  );
}
