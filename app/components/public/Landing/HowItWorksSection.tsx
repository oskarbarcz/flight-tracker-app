...
export function HowItWorksSection() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ([e]) => {
        // Sentinel is just above the sticky part. 
        // If it's not intersecting the -64px threshold, the header is pinned.
        setIsStuck(e.intersectionRatio === 0);
      },
      {
        threshold: [0, 1],
        rootMargin: "-64px 0px 0px 0px", // Exactly the navbar height
      }
    );
  ...
  return (
    <section className="pt-6 bg-gray-50 dark:bg-[#0c0c0e] relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 -right-20 w-[500px] h-[500px] bg-purple-500/10 dark:bg-purple-500/5 rounded-full blur-[150px]" />
      </div>

      <div className="relative z-10 pb-0 md:pb-48">

        {/* Sentinel for sticky shadow activation */}
        <div ref={sentinelRef} className="absolute top-0 h-16 w-full pointer-events-none" />

        {/* Unified Sticky Header (Mobile & Desktop) */}
        <div
          className={`sticky top-15 z-30 transition-all duration-500 ${isStuck
        ...
        <div className="hidden md:block mx-auto max-w-7xl px-6 lg:px-8 relative mt-24">
          {/* Vertical Line */}
          <div className="absolute left-1/2 top-4 -bottom-48 w-1 -ml-[0.5px] rounded-full bg-gradient-to-b from-indigo-500 via-indigo-500 to-purple-500 opacity-20"></div>
        ...
        <div className="md:hidden mx-auto max-w-7xl px-4 relative mt-12">
          <div className="space-y-10 relative">
            {/* Vertical Line */}
            <div className="absolute left-[20px] top-4 -bottom-10 w-1 -ml-[0.5px] rounded-full bg-gradient-to-b from-indigo-500 via-indigo-500 to-purple-500 opacity-20 z-0"></div>
