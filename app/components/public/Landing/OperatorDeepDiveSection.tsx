...
const operatorFeatures = [
  {
    ...
    description: "From initial scheduling to pinpoint precision on the loadsheet. Master every parameter before the engines even start.",
  ...
  },
  {
    ...
    description: "See exactly where every aircraft is parked or flying. Track real-time fleet age and effortlessly manage complex daily crew rotations—all from a single, unified view.",
  ...
  },
  {
    ...
    description: "Understand exactly where your airline zones reside. Locate active parking areas, define Schengen constraints, and coordinate massive ground operations visually.",
