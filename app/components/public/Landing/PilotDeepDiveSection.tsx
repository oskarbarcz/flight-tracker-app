...
const pilotFeatures = [
  {
    ...
    description: "Get loadsheets, confirm them seamlessly, and dive into the most professional briefing customized for your flight simulation purposes.",
  ...
  },
  {
    ...
    description: "Connect deeply with your simulation ecosystem. Review the generated manifests, track boarding natively, and coordinate exactly who is riding along with you.",
  ...
  },
  {
    ...
    description: "Know your departure airport intimately, review your exact route, and watch your flight progress live dynamically over the map.",
