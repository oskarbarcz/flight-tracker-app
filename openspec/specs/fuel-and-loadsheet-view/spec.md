...
Present a loadsheet's planned fuel breakdown as an operational-flight-plan-style ladder alongside the loadsheet figures, with independent preliminary/final switches, surfaced to operators (flight-detail tab) and pilots (live-tracking and flight-history tabs).
